 ...
 * @author alcovp
 */
public class WorkoutCreatePanel extends Panel {

    @Inject
    private IGymDairyService gymDairyService;

    public WorkoutCreatePanel(String id, final ModalWindow window, final AjaxReadinessListener onSave) {
        super(id);

        final IModel<Workout> workout = new Model<>(new Workout());
        workout.getObject().setDate(new Date());
        ...
        form.add(new AddMovesPanel("moves", workout));
        ...
        form.add(new AjaxButton("save") {
            ...
            protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
                gymDairyService.createWorkout(workout.getObject(), GymDairyAuthenticatedWebSession.get().getCurrentUserId());
