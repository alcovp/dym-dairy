 ...
 * @author alcovp
 */
public class MoveDeclarationCreatePanel extends Panel {

    @Inject
    private IGymDairyService gymDairyService;

    public MoveDeclarationCreatePanel(String id, final ModalWindow window,
                                      AjaxReadinessListener onSave) {
        super(id);
        ...
        form.add(new AjaxButton("save") {
            ...
            protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
                gymDairyService.createMoveDeclaration(declaration, GymDairyAuthenticatedWebSession.get().getCurrentUserId());
